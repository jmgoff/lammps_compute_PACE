...
#else
ComputeStyle(pace/kk/device,ComputePACEKokkos<LMPHostType>);
#endif
// clang-format on
#else
...
//class ComputePACEKokkos : public {
//class ComputePACEKokkos : public ComputePACE {
class ComputePACEKokkos : public Compute {
 public:
  ...
  struct TagComputePACEComputeRho{};
  struct TagComputePACEComputeFS{};
  struct TagComputePACEComputeWeights{};
  struct TagComputePACEComputeDerivative{};

  template<int NEIGHFLAG, int EVFLAG>
  struct TagComputePACEComputeForce{};
  ...
  void operator() (TagComputePACEComputeNeigh,const typename Kokkos::TeamPolicy<DeviceType, TagComputePACEComputeNeigh>::member_type& team) const;

  KOKKOS_INLINE_FUNCTION
  void operator() (TagComputePACEComputeRadial,const typename Kokkos::TeamPolicy<DeviceType, TagComputePACEComputeRadial>::member_type& team) const;

  KOKKOS_INLINE_FUNCTION
  void operator() (TagComputePACEComputeAi,const typename Kokkos::TeamPolicy<DeviceType, TagComputePACEComputeAi>::member_type& team) const;

  KOKKOS_INLINE_FUNCTION
  void operator() (TagComputePACEConjugateAi,const int& ii) const;

  KOKKOS_INLINE_FUNCTION
  void operator() (TagComputePACEComputeRho,const int& iter) const;

  KOKKOS_INLINE_FUNCTION
  void operator() (TagComputePACEComputeFS,const int& ii) const;

  KOKKOS_INLINE_FUNCTION
  void operator() (TagComputePACEComputeWeights,const int& iter) const;

  KOKKOS_INLINE_FUNCTION
  void operator() (TagComputePACEComputeDerivative,const typename Kokkos::TeamPolicy<DeviceType, TagComputePACEComputeDerivative>::member_type& team) const;

  template<int NEIGHFLAG, int EVFLAG>
  KOKKOS_INLINE_FUNCTION
  void operator() (TagComputePACEComputeForce<NEIGHFLAG,EVFLAG>,const int& ii) const;

  template<int NEIGHFLAG, int EVFLAG>
  KOKKOS_INLINE_FUNCTION
  void operator() (TagComputePACEComputeForce<NEIGHFLAG,EVFLAG>,const int& ii, EV_FLOAT&) const;
 ...
 protected:
  ...
  //friend void pair_virial_fdotr_compute<ComputePACEKokkos>(ComputePACEKokkos*);
